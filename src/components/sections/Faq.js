...
<Box>
  ...
  Վարժանքները կազմված են բացատրական նյութերից և նրանց վերաբերող հարցերից։
  </Accordion>
  <Accordion ScrollTrigger={ScrollTrigger} title="ԻՆՉՊԵ՞Ս ԵՆ ԱՆՑԿԱՑՎՈՒՄ ԴԱՍԸՆԹԱՑՆԵՐԸ" >
  Դասընթացները անցկացվում է առցանց տարբերակով որի ընթացքում ավելի են խորացնելու վարժանքներում յուրացված նյութերը և սովորելու են նոր թեմաններ որոնք չկան վարժանքներում։

  </Accordion>
  <Accordion ScrollTrigger={ScrollTrigger} title="ՈՎՔԵ՞Ր ԿԱՐՈՂ ԵՆ ՄԻԱՆԱԼ ITBrain-ԻՆ" >
  ITBrain-ում կարող են հաշիվ ունենալ բոլոր տարիքային մարդիկ ովքեր շահագրգռված են սովորել։
  </Accordion>
</Box>
<Box>
